...
// Geçici tip tanımları - order response için flexible type
export interface OrderProductWithProductDetails {
  [key: string]: any; // Flexible type for all possible fields
  id: number;
  farmer_id: number;
  product_id: number;
  quantity: number;
